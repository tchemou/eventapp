    ...
    return Scaffold(
      ...
      body: Consumer<TicketProvider>(
        builder: (context, provider, child) {
          ...
          final validTickets =
              provider.tickets.where((t) => t.status == 'VALID').toList();
          final pastTickets =
              provider.tickets.where((t) => t.status != 'VALID').toList();
            ...
            children: [
              validTickets.isEmpty
                  ? _buildEmptyState(
                      ...
                      subtitle:
                          'Vos billets pour les prochains événements\napparaîtront ici',
                    )
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            // ✅ FIX : ticketNumber n'existe pas dans Ticket → remplacé par id
            title: Text(
              'Billet #${ticket.id}',
              style: const TextStyle(fontWeight: FontWeight.bold),
            ),
            // ✅ FIX : status est String? → utiliser ?? 'INCONNU'
            subtitle: Text('Statut: ${ticket.status ?? 'INCONNU'}'),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child:
                  Icon(icon, size: 64, color: context.gold.withOpacity(0.6)),
            ),
