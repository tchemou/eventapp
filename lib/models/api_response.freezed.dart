...
class _$PaginatedResponseImpl<T> implements _PaginatedResponse<T> {
  ...
  @override
  String toString() {
    return 'PaginatedResponse<$T>(content: $content, page: $page, pageSize: $pageSize, totalElements: $totalElements, totalPages: $totalPages, hasNext: $hasNext, hasPrevious: $hasPrevious)';
  }
...
abstract class _PaginatedResponse<T> implements PaginatedResponse<T> {
  const factory _PaginatedResponse(
      ...
      required final bool hasPrevious}) = _$PaginatedResponseImpl<T>;
